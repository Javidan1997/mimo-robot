...
- **Servos:** PCA9685 16-ch I2C driver + 6x **MG90S 180° metal-gear** servos (neck/head,
  arms; NOT 360° - avoid continuous-rotation for positional joints).
- **Sensors:** 2x VL53L0X ToF distance, TTP223 capacitive touch modules, MPU6050 gyro/accel.
